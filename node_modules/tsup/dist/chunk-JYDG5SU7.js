...
var _chunkI6PX3SVZjs = require('./chunk-I6PX3SVZ.js');
...
var _chunk4N3ACFW7js = require('./chunk-4N3ACFW7.js');
...
var loadJson = async (filepath) => {
  try {
    return _chunk4N3ACFW7js.jsoncParse.call(void 0, await _fs2.default.promises.readFile(filepath, "utf8"));
  } catch (error) {
...
var colorize = (type, data, onlyImportant = false) => {
  ...
  return _chunkI6PX3SVZjs.colorette_exports[color](data);
};
var makeLabel = (name, input, type) => {
  return [
    name && `${_chunkI6PX3SVZjs.dim.call(void 0, "[")}${name.toUpperCase()}${_chunkI6PX3SVZjs.dim.call(void 0, "]")}`,
      ...
      switch (type) {
        case "error": {
          if (!_worker_threads.isMainThread) {
            _optionalChain([_worker_threads.parentPort, 'optionalAccess', _2 => _2.postMessage, 'call', _3 => _3({
              type: "error",
        ...
        default:
          if (silent) return;
          if (!_worker_threads.isMainThread) {
            _optionalChain([_worker_threads.parentPort, 'optionalAccess', _4 => _4.postMessage, 'call', _5 => _5({
              type: "log",
              text: _util2.default.format(...args)
            })]);
            return;
  ...
  return {
    ...
    setup(build2) {
      ...
      const getPostcssConfig = async () => {
        const loadConfig = _chunk4N3ACFW7js.__require.call(void 0, "postcss-load-config");
        if (configCache) {
          return configCache;
        }
        try {
      ...
      build2.onLoad({ filter: /\.css$/ }, async (args) => {
        ...
        if (plugins && plugins.length > 0) {
          const postcss = _chunk4N3ACFW7js.getPostcss.call(void 0, );
          if (!postcss) {
            return {
              errors: [
                {
          ...
          const result = await _optionalChain([postcss, 'optionalAccess', _6 => _6.default, 'call', _7 => _7(plugins), 'access', _8 => _8.process, 'call', _9 => _9(contents, { ...options, from: args.path })]);
          contents = result.css;
        }
        if (inject) {
  ...
  return {
    ...
    setup(build2) {
      ...
      build2.onLoad({ filter: /\.svelte$/ }, async (args) => {
        svelte = svelte || _chunk4N3ACFW7js.localRequire.call(void 0, "svelte/compiler");
        sveltePreprocessor = sveltePreprocessor || _chunk4N3ACFW7js.localRequire.call(void 0, "svelte-preprocess");
        if (!svelte) {
          return {
...
var swcPlugin = ({ logger: logger3 }) => {
  return {
    name: "swc",
    setup(build2) {
      const swc = _chunk4N3ACFW7js.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        logger3.warn(
  ...
  return {
    ...
    setup(build2) {
      build2.onResolve({ filter: /\.node$/, namespace: "file" }, (args) => {
        const resolvedId = _chunk4N3ACFW7js.__require.resolve(args.path, {
...
var getOutputExtensionMap = (options, format, pkgType) => {
  const outExtension = options.outExtension || _chunk4N3ACFW7js.defaultOutExtension;
  const defaultExtension = _chunk4N3ACFW7js.defaultOutExtension.call(void 0, { format, pkgType });
...
async function runEsbuild(options, {
  ...
  try {
    result = await _esbuild.build.call(void 0, {
      ...
      plugins: esbuildPlugins.filter(_chunk4N3ACFW7js.truthy),
      define: {
...
var swcTarget = () => {
  ...
  return {
    ...
    async renderChunk(code, info) {
      ...
      const swc = _chunk4N3ACFW7js.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        throw new (0, _chunkI6PX3SVZjs.PrettyError)(
...
var reportSize = (logger3, format, files) => {
  const filenames = Object.keys(files);
  const maxLength = getLengthOfLongestString(filenames) + 1;
  for (const name of filenames) {
    logger3.success(
      format,
      `${_chunkI6PX3SVZjs.bold.call(void 0, padRight(name, maxLength))}${_chunkI6PX3SVZjs.green.call(void 0, 
...
var isInPublicDir = (publicDir, filePath) => {
  ...
  const publicPath = _chunk4N3ACFW7js.slash.call(void 0, 
    _path2.default.resolve(publicDir === true ? "public" : publicDir)
  );
  return _chunk4N3ACFW7js.slash.call(void 0, _path2.default.resolve(filePath)).startsWith(`${publicPath}/`);
};
  ...
  return {
    ...
    async renderChunk(code, info) {
      if (minifyOptions !== "terser" || !/\.(cjs|js|mjs)$/.test(info.path))
        return;
      const terser = _chunk4N3ACFW7js.localRequire.call(void 0, "terser");
      if (!terser) {
        throw new (0, _chunkI6PX3SVZjs.PrettyError)(
...
function getExports(program, fileMapping) {
  ...
  function extractExports(sourceFileName) {
    ...
    sourceFileName = _chunk4N3ACFW7js.toAbsolutePath.call(void 0, sourceFileName, cwd);
...
function emitDtsFiles(program, host) {
  ...
  let writeFile = (fileName, text, writeByteOrderMark, onError, sourceFiles, data) => {
    ...
    let sourceFileName = _optionalChain([sourceFile, 'optionalAccess', _19 => _19.fileName]);
    if (sourceFileName && !fileName.endsWith(".map")) {
      const cwd = program.getCurrentDirectory();
      fileMapping.set(
        _chunk4N3ACFW7js.toAbsolutePath.call(void 0, sourceFileName, cwd),
        _chunk4N3ACFW7js.toAbsolutePath.call(void 0, fileName, cwd)
      );
    }
...
function emit(compilerOptions, tsconfig) {
  ...
  let declarationDir = _chunk4N3ACFW7js.ensureTempDeclarationDir.call(void 0, );
...
function runTypeScriptCompiler(options) {
  try {
    ...
    _chunkI6PX3SVZjs.handleError.call(void 0, error);
...
function formatAggregationExports(exports, declarationDirPath) {
  ...
  ).filter(_chunk4N3ACFW7js.truthy);
  if (lines.length === 0) {
    lines.push("export {};");
  }
  return lines.join("\n") + "\n";
...
function formatAggregationExport(declaration, declarationDirPath) {
  let dest = _chunk4N3ACFW7js.trimDtsExtension.call(void 0, 
    "./" + _path2.default.posix.normalize(
      _chunk4N3ACFW7js.slash.call(void 0, _path2.default.relative(declarationDirPath, declaration.destFileName))
    )
  );
  if (declaration.kind === "module") {
    ...
    return [
      ...
      "} from",
      `'${dest}';`
    ].filter(_chunk4N3ACFW7js.truthy).join(" ");
  } else {
    throw new Error("Unknown declaration");
  }
}
function formatDistributionExports(exports, fromFilePath, toFilePath) {
  let importPath = _chunk4N3ACFW7js.trimDtsExtension.call(void 0, 
    _path2.default.posix.relative(
      _path2.default.posix.dirname(_path2.default.posix.normalize(_chunk4N3ACFW7js.slash.call(void 0, fromFilePath))),
      _path2.default.posix.normalize(_chunk4N3ACFW7js.slash.call(void 0, toFilePath))
    )
  );
  if (!importPath.match(/^\.+\//)) {
  ...
  }).map((declaration) => formatDistributionExport(declaration, importPath)).filter(_chunk4N3ACFW7js.truthy);
  if (lines.length === 0) {
    lines.push("export {};");
  }
  return lines.join("\n") + "\n";
...
function rollupDtsFile(inputFilePath, outputFilePath, tsconfigFilePath) {
  ...
  const imported = _chunk4N3ACFW7js.getApiExtractor.call(void 0, );
  if (!imported) {
    throw new Error(
...
async function rollupDtsFiles(options, exports, format) {
  ...
  let dtsExtension = _chunk4N3ACFW7js.defaultOutExtension.call(void 0, { format, pkgType: pkg.type }).dts;
  ...
  _chunk4N3ACFW7js.writeFileSync.call(void 0, 
    dtsInputFilePath,
  ...
  for (let [out, sourceFileName] of Object.entries(
    ...
    sourceFileName = _chunk4N3ACFW7js.toAbsolutePath.call(void 0, sourceFileName);
...
function cleanDtsFiles(options) {
  if (options.clean) {
    _chunk4N3ACFW7js.removeFiles.call(void 0, ["**/*.d.{ts,mts,cts}"], options.outDir);
  }
}
...
var cjsInterop = () => {
  return {
    name: "cjs-interop",
    async renderChunk(code, info) {
      if (!this.options.cjsInterop || this.format !== "cjs" || info.type !== "chunk" || !/\.(js|cjs)$/.test(info.path) || !info.entryPoint || _optionalChain([info, 'access', _22 => _22.exports, 'optionalAccess', _23 => _23.length]) !== 1 || info.exports[0] !== "default") {
        return;
      }
      return {
...
var normalizeOptions = async (logger3, optionsFromConfigFile, optionsOverride) => {
  ...
  const options = {
    ...
    experimentalDts: _options.experimentalDts ? typeof _options.experimentalDts === "boolean" ? _options.experimentalDts ? { entry: {} } : void 0 : typeof _options.experimentalDts === "string" ? {
      entry: _chunk4N3ACFW7js.toObjectEntry.call(void 0, _options.experimentalDts)
    } : {
      ..._options.experimentalDts,
      entry: _chunk4N3ACFW7js.toObjectEntry.call(void 0, _options.experimentalDts.entry || {})
    } : void 0
  };
  setSilent(options.silent);
  const entry = options.entry || options.entryPoints;
  if (!entry || Object.keys(entry).length === 0) {
    throw new (0, _chunkI6PX3SVZjs.PrettyError)(`No input files, try "tsup <your-file>" instead`);
  }
  if (Array.isArray(entry)) {
    options.entry = await _globby2.default.call(void 0, entry);
    if (!options.entry || options.entry.length === 0) {
      throw new (0, _chunkI6PX3SVZjs.PrettyError)(`Cannot find ${entry}`);
    } else {
    ...
    Object.keys(entry).forEach((alias) => {
      ...
      if (!_fs2.default.existsSync(filename)) {
        throw new (0, _chunkI6PX3SVZjs.PrettyError)(`Cannot find ${alias}: ${filename}`);
      }
    });
    options.entry = entry;
  ...
  if (tsconfig) {
    ...
    options.tsconfigResolvePaths = _optionalChain([tsconfig, 'access', _24 => _24.data, 'optionalAccess', _25 => _25.compilerOptions, 'optionalAccess', _26 => _26.paths]) || {};
    options.tsconfigDecoratorMetadata = _optionalChain([tsconfig, 'access', _27 => _27.data, 'optionalAccess', _28 => _28.compilerOptions, 'optionalAccess', _29 => _29.emitDecoratorMetadata]);
    if (options.dts) {
    ...
    if (options.experimentalDts) {
      ...
      options.experimentalDts.entry = _chunk4N3ACFW7js.toObjectEntry.call(void 0, 
        Object.keys(options.experimentalDts.entry).length > 0 ? options.experimentalDts.entry : options.entry
      );
    }
    if (!options.target) {
      options.target = _optionalChain([tsconfig, 'access', _30 => _30.data, 'optionalAccess', _31 => _31.compilerOptions, 'optionalAccess', _32 => _32.target, 'optionalAccess', _33 => _33.toLowerCase, 'call', _34 => _34()]);
    }
  } else if (options.tsconfig) {
    throw new (0, _chunkI6PX3SVZjs.PrettyError)(`Cannot find tsconfig: ${options.tsconfig}`);
  }
  if (!options.target) {
...
async function build(_options) {
  const config = _options.config === false ? {} : await loadTsupConfig(
    process.cwd(),
  ...
  await Promise.all(
    [...Array.isArray(configData) ? configData : [configData]].map(
      async (item) => {
        const logger3 = createLogger(_optionalChain([item, 'optionalAccess', _35 => _35.name]));
        const options = await normalizeOptions(logger3, item, _options);
        logger3.info("CLI", `tsup v${_chunk4N3ACFW7js.version}`);
        if (config.path) {
        ...
        const dtsTask = async () => {
          ...
          if (options.dts) {
            await new Promise((resolve, reject) => {
              ...
              worker.postMessage({
                configName: _optionalChain([item, 'optionalAccess', _36 => _36.name]),
                options: {
                  ...options,
        ...
        const mainTasks = async () => {
          if (!_optionalChain([options, 'access', _37 => _37.dts, 'optionalAccess', _38 => _38.only])) {
            ...
            const debouncedBuildAll = _chunk4N3ACFW7js.debouncePromise.call(void 0, 
              () => {
                return buildAll();
              },
              100,
              _chunkI6PX3SVZjs.handleError
            );
            const buildAll = async () => {
              ...
              if (options.clean) {
                ...
                await _chunk4N3ACFW7js.removeFiles.call(void 0, ["**/*", ...extraPatterns], options.outDir);
            ...
            const startWatcher = async () => {
              ...
              watcher.on("all", async (type, file) => {
                file = _chunk4N3ACFW7js.slash.call(void 0, file);
...
exports.loadPkg = loadPkg; exports.getProductionDeps = getProductionDeps; exports.setSilent = setSilent; exports.createLogger = createLogger; exports.reportSize = reportSize; exports.defineConfig = defineConfig2; exports.build = build;
